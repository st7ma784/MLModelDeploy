...
##GPUS
We know you're a student who may not have a hardware budget assigned. So we have written a  nomadscript that shows how to collect your build docker container from a repo and run it as a service that can be accessed in the same way 
